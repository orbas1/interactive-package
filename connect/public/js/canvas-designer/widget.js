...
(function() {
    ...
    find('main-canvas').width = innerWidth;
    find('main-canvas').height = innerHeight;

    find('temp-canvas').width = innerWidth;
    find('temp-canvas').height = innerHeight;
    ...
    var eraserHandler = {
        ...
        mousedown: function(e) {
            ...
            tempContext.lineCap = 'round';
            // force eraser to stroke white color
            // tempContext.strokeStyle = '#ffffff';
            drawHelper.line(tempContext, [t.prevX, t.prevY, x, y]);

            // force eraser to stroke white color
            // points[points.length] = ['line', [t.prevX, t.prevY, x, y], drawHelper.getOptions({ strokeStyle: '#ffffff' })];
    ...
    var webrtcHandler = {
        createOffer: function(callback) {
            var captureStream = document.getElementById('main-canvas').captureStream(30);
