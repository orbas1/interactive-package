...
<head>
    ...
    <title>Updating the Application, please wait!</title>
    <style type="text/css">
        body,
        html {
            padding: 0;
        ...
        .error .btn:hover, .error .btn:active {
            background: #9CA3AF;
            color: #1F2937;
            text-decoration: none;
        }
...
<body>
    <div class="container">
        <div class="error">
            ...
            <p>Oops, you caught us updating the application! Don't worry we will be back in few seconds!</p>
            <p>If you are still seeing this page please inform us at <a href="mailto:hi@kodemint.in" target="_blank">hi@kodemint.in</a>.</p>

            <button type="button" onclick="location.reload()" class="btn">Reload the page!</button>
        </div>
