                    ...
                    <div class="row gy-4">
                        <div class="col-xl-9 col-lg-10">
                            <div class="contactus-form">
                                <h3 class="contact__title"> @lang('Add Balance') </h3>
                                           ...
                                           <div class="col-sm-12">
                                            <label class="form-label required" for="amount">@lang('Amount')</label>
                                                <div class="input-group country-code">
                                                    ...
                                                    <input type="number" step="any" name="amount" class="form-control form--control mobile-code" value="{{ old('amount') }}" autocomplete="off" required>
